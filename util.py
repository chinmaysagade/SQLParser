...
str='''ABORT|ABS|ABSOLUTE|ACCESS|ADA|ADD|ADMIN|AFTER|AGGREGATE|
        ...
        DOMAIN|DROP|DYNAMIC|DYNAMIC_FUNCTION|DYNAMIC_FUNCTION_CODE|EXISTS|
        EACH|ELSE|ENCODING|ENCRYPTED|END|END-EXEC|EQUALS|ESCAPE|EVERY|EXCEPT|
        ...
        GROUP|GLOB|GROUPING|HANDLER|HAVING|HIERARCHY|HOLD|HOST|IDENTITY|
        IGNORE|ILIKE|IMMEDIATE|IMMUTABLE|IMPLEMENTATION|IMPLICIT|IN|
        INCLUDING|INCREMENT|INDEX|INDEXED|INDITCATOR|INFIX|INHERITS|INITIALIZE|
        ...
        NOTIFY|NOTNULL|NULL|NULLABLE|NULLIF|OBJECT|OCTET_LENGTH|OF|OFF|OR|
        ...
        ROLE|ROLLBACK|ROLLUP|ROUTINE|ROUTINE_CATALOG|ROUTINE_NAME|REGEXP|
